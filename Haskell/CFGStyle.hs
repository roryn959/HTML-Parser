...
--Does not account for nested tags.
...
--Given a tag and a list of tags, find the tag which closes the given tag.
--Accounts for nested tags -> given ["div", "div", "/div", "/div"] and "div",
--it will return 3 as this is the index of the closing tag relating to the first div tag seen.
...
{-
HTML Context-Free Grammar

-------------------------

S -> HTML
HTML -> <html> MAIN </html>
MAIN -> statement_list HEAD statement_list BODY statement_list
HEAD -> <head> statement_list TITLE statement_list </head>
TITLE -> <title> non_flow </title>
BODY -> <body> statement_list </body>
non_flow -> <br> | <hr> | <h1></h1> | <h2></h2> | <h3></h3> | <a></a>
statement_list -> statement statement_list | ε
statement -> non_flow | LIST | DIV | P
LIST -> <ul> LIST_CONTENT </ul>
LIST_CONTENT -> <li> LIST_ELEMENT </li> LIST_CONTENT | ε
LIST_ELEMENT -> non_flow | DIV | P
DIV -> <div> statement_list </div>
P -> <p> non_flow </p>
